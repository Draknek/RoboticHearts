package net.flashpunk.graphics 
{
	...
	public class Text extends Image
	{
		...
		/**
		 * The antiAliasType to assign to new Text objects.
		 */
		public static var defaultAntiAliasType:String = AntiAliasType.NORMAL;
		
		/**
		 * The sharpness to assign to new Text objects (only used if antiAliasType is set to advanced).
		 */
		public static var defaultSharpness:Number = 0;
		
		/**
		 * The thickness to assign to new Text objects (only used if antiAliasType is set to advanced).
		 */
		...
		public function Text(text:String, x:Number = 0, y:Number = 0, options:Object = null, h:Number = 0)
		{
			...
			_field.sharpness = Text.defaultSharpness;
			_field.thickness = Text.defaultThickness;
		...
		/**
		 * The type of anti-aliasing used for this text field. See flash.text.AntiAliasType for accepted values.
		 */
		public function get antiAliasType():String { return _field.antiAliasType; }
		public function set antiAliasType(value:String):void
		{
			if (_field.antiAliasType == value) return;
			_field.antiAliasType = value;
			updateTextBuffer();
		}
		
		/**
		 * The sharpness of the glyph edges in this text field (between -400 and 400). Only used if antiAliasType is advanced.
		 */
		public function get sharpness():Number { return _field.sharpness; }
		public function set sharpness(value:Number):void
		{
			if (_field.sharpness == value) return;
			_field.sharpness = value;
			updateTextBuffer();
		}
		
		/**
		 * The thickness of the glyph edges in this text field (between -200 and 200). Only used if antiAliasType is advanced.
		 */
		public function get thickness():Number { return _field.thickness; }
		public function set thickness(value:Number):void
		{
			if (_field.thickness == value) return;
			_field.thickness = value;
			updateTextBuffer();
		}
